  ...
  return (
    <div>
      ...
      <section
        ...
        style={{ backgroundImage: `url(${honeyBrass})` }}
      >
        <div className="absolute inset-0 bg-black/60 flex flex-col items-center justify-center text-center text-white px-4">
          ...
          >
            Your trusted partner for high-quality brass scrap trading. We
            provide the best materials to meet your industrial needs.
          </motion.p>
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            <img
              src={honeyBrass}
              alt="Honey Brass Scrap"
              className="w-full h-48 object-cover rounded-md mb-4"
            />
            <h3 className="text-xl font-semibold mb-2">Honey Brass Scrap</h3>
            <p>
              High-quality brass scrap with a golden hue, perfect for various
          ...
          >
            <img
              src={vilayatiBrass}
              alt="Vilayati Brass Scrap"
              className="w-full h-48 object-cover rounded-md mb-4"
            />
            <h3 className="text-xl font-semibold mb-2">Vilayati Brass Scrap</h3>
            <p>
              Premium imported brass scrap, known for its superior quality and
